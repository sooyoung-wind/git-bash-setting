...
function _omb_theme_PROMPT_COMMAND() {
  ...
  local user_host="${_omb_prompt_green}\u ${_omb_prompt_teal}in ${_omb_prompt_normal}"
  ...
  _omb_prompt_get_python_venv && python_venv="$_omb_prompt_bold_brown$python_venv$_omb_prompt_normal "
  ...
  PS1="${dtime}${user_host}${current_dir}${ruby_env}${git_branch}
${python_venv}${_omb_prompt_bold_teal}${arrow}$prompt"
}
